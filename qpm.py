...
import QPM_Solver.QPMSolver as qpm
...
find_P = True
# enter known polling periods [(e-wave), (o-wave)] HCP = [10.603212266659575, 9.046371465669914]
P_known = [26.25, 26.25]
T_find = 104            # Temperature of optimum conversion
...
units = [0.942, 2.40322] #   [193381070, 301344380] # [0.995, 1.55] # 
# Sellmeier co-efficients for the HCP waveguide
...
wavelengths, frequencies = qpm.create_lists(units, unit_type=input, mode=mode)
...
if find_P == True:
    ...
    Pe_0 = qpm.find_P0(T_find, temperatures, ke, T_0, alpha, mode=mode)
    Po_0 = qpm.find_P0(T_find, temperatures, ko, T_0, alpha, mode=mode)
else:
...
delta_ke = qpm.calculate_dk(Pe, ke, mode=mode)
delta_ko = qpm.calculate_dk(Po, ko, mode=mode)
